...
/** @type {string} */
const CACHE_VERSION = '1734321609|4735345111';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["alcanzalos_huesitos.html","alcanzalos_huesitos.js","alcanzalos_huesitos.offline.html","alcanzalos_huesitos.icon.png","alcanzalos_huesitos.apple-touch-icon.png","alcanzalos_huesitos.worker.js","alcanzalos_huesitos.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["alcanzalos_huesitos.wasm","alcanzalos_huesitos.pck"];
